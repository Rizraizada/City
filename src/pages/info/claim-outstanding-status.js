...
import { Shield } from "lucide-react"; // Importing Shield icon for policies
...
const claim = () => {
  ...
  const tabs = [
    {
      id: "tab1",
      title: "Claim Outstanding Status",
      icon: Shield,
      color: "green",
    },
  ];
          ...
          <TabContent isActive={activeTab === "tab1"}>
            ...
            >
              ...
              <div className="policy-container">
                <div className="policy-item" onClick={() => window.open(`/path/to/privacy-policy.pdf`, "_blank")}>
                  Kyc
                </div>
