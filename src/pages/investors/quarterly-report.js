                ...
                <div className="year-container">
                  ...
                  <div className="quarterly-reports">
                    <div className="report-item">
                      <a
                        onClick={() =>
                          window.open(`/path/to/2016-Q1-report.pdf`, "_blank")
                        }
                      >
                        1. Q1 2016 Report
                      </a>
                    ...
                    <div className="report-item">
                      <a
                        onClick={() =>
                          window.open(`/path/to/2016-Q2-report.pdf`, "_blank")
                        }
                      >
                        2. Q2 2016 Report
                      </a>
                    ...
                    <div className="report-item">
                      <a
                        onClick={() =>
                          window.open(`/path/to/2016-Q3-report.pdf`, "_blank")
                        }
                      >
                        3. Q3 2016 Report
                      </a>
                ...
                <div className="year-container">
                  ...
                  <div className="quarterly-reports">
                    <div className="report-item">
                      <a
                        onClick={() =>
                          window.open(`/path/to/2017-Q1-report.pdf`, "_blank")
                        }
                      >
                        1. Q1 2017 Report
                      </a>
                    ...
                    <div className="report-item">
                      <a
                        onClick={() =>
                          window.open(`/path/to/2017-Q2-report.pdf`, "_blank")
                        }
                      >
                        2. Q2 2017 Report
                      </a>
                    ...
                    <div className="report-item">
                      <a
                        onClick={() =>
                          window.open(`/path/to/2017-Q3-report.pdf`, "_blank")
                        }
                      >
                        3. Q3 2017 Report
                      </a>
                  ...
                  <div key={year} className="year-container">
                    ...
                    <div className="quarterly-reports">
                      <div className="report-item">
                        <a
                          onClick={() =>
                            window.open(`/path/to/${year}-Q1-report.pdf`, "_blank")
                          }
                        >
                          1. Q1 {year} Report
                        </a>
                      ...
                      <div className="report-item">
                        <a
                          onClick={() =>
                            window.open(`/path/to/${year}-Q2-report.pdf`, "_blank")
                          }
                        >
                          2. Q2 {year} Report
                        </a>
                      ...
                      <div className="report-item">
                        <a
                          onClick={() =>
                            window.open(`/path/to/${year}-Q3-report.pdf`, "_blank")
                          }
                        >
                          3. Q3 {year} Report
                        </a>
