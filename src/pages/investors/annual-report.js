          ...
          <TabContent isActive={activeTab === "tab1"}>
            ...
            >
              <h2 className="content-title">
                <FileText className="content-icon text-indigo-500" />
                Annual Reports
              </h2>
              ...
              <div className="years-container">
                ...
                <div className="year-container">
                  <div className="year-title">Year: 2024</div>
                  <div className="annual-reports">
                    <div className="report-item">
                      <a
                        onClick={() =>
                          window.open(`/Annual-Report-2023.pdf`, "_blank")
                        }
                      >
                ...
                <div className="year-container">
                  ...
                  <div className="annual-reports">
                    <div className="report-item">
                      <a
                        onClick={() =>
                          window.open(`/path/to/annual-report-2017.pdf`, "_blank")
                        }
                      >
                  ...
                  <div key={year} className="year-container">
                    ...
                    <div className="annual-reports">
                      <div className="report-item">
                        <a
                          onClick={() =>
                            window.open(`/path/to/annual-report-${year}.pdf`, "_blank")
                          }
                        >
