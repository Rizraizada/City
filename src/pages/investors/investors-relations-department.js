...
import { Users } from "lucide-react"; // Importing Users icon for Investors Relations
...
const InvestorsRelations = () => {
  ...
  const tabs = [
    {
      id: "tab1",
      title: "Investors Relations Department",
      icon: Users,
      color: "green",
    },
  ];
          ...
          <TabContent isActive={activeTab === "tab1"}>
            ...
            >
              <h2 className="content-title">
                <Users className="content-icon text-green-500" />
                Investors Relations Department
              </h2>

              <div className="declaration-container">
                <div className="declaration-item">
                  Name of the Official Md. Nazrul Islam, <br />QCS Assistant Manager<br />
                  Phone: +88-0222 3387281, Ext. – 206 E mail:<br />
                  share@cityinsurance.com.bd{" "}
                </div>
