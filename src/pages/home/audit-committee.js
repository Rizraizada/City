// src/pages/home/audit-committee.js
...
const AuditCommittee = () => {
  ...
  useEffect(() => {
    const fetchDirectors = async () => {
      try {
        // Fetch directors specifically for the Audit Committee
        const response = await fetch(`${BASE_URL}/api/director?committee=Audit Committee`);
        if (!response.ok) {
